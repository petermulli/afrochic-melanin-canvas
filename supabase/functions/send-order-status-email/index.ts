...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailResponse = await resend.emails.send({
      from: "AfroChic <onboarding@resend.dev>",
      to: [user.email],
        ...
        <html>
          <head>
            <style>
              ...
              .status-badge { display: inline-block; padding: 8px 16px; background: #667eea; color: white; border-radius: 20px; font-weight: 600; text-transform: uppercase; font-size: 12px; margin: 20px 0; }
          ...
          <body>
            <div class="container">
              <div class="header">
                <h1 style="margin: 0; font-size: 28px;">AfroChic</h1>
              ...
              <div class="content">
                ...
                <p>Thank you for shopping with AfroChic!</p>
                <div class="footer">
                  <p>AfroChic - Celebrating African Beauty</p>
