...
const dummyReviews: Review[] = [
  { id: "d1", reviewer_name: "Amara Okonkwo", review_text: "This serum completely transformed my skin! The hyperpigmentation I've been fighting for years has faded significantly.", rating: 5, product_name: "Brightening Vitamin C Serum", image: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&h=400&fit=crop&crop=face" },
  { id: "d2", reviewer_name: "Zuri Mwangi", review_text: "I've tried countless products for my oily skin, but this moisturizer is perfect. It controls shine without drying me out.", rating: 5, product_name: "Oil-Free Hydrating Gel", image: "https://images.unsplash.com/photo-1614283233556-f35b0c801ef1?w=400&h=400&fit=crop&crop=face" },
  { id: "d3", reviewer_name: "Adaeze Nwosu", review_text: "Finally a brand that understands melanin-rich skin! The dark spot corrector works wonders.", rating: 5, product_name: "Dark Spot Corrector", image: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&h=400&fit=crop&crop=face" },
  ...
  { id: "d5", reviewer_name: "Aisha Abubakar", review_text: "Best investment I've made for my skincare routine. The anti-aging serum has reduced my fine lines.", rating: 5, product_name: "Retinol Night Serum", image: "https://images.unsplash.com/photo-1592621385612-4d7129426394?w=400&h=400&fit=crop&crop=face" },
  { id: "d6", reviewer_name: "Wanjiku Kamau", review_text: "The sunscreen is incredible! No white cast. Perfect for daily wear under makeup.", rating: 5, product_name: "Invisible SPF 50", image: "https://images.unsplash.com/photo-1618333258404-f509733839c4?w=400&h=400&fit=crop&crop=face" },
];
