...
export const LANDING_IMAGE_SLOTS = [
  ...
  { key: "collection_1", label: "Featured Collection — Card 1", width: 600, height: 800, note: "Portrait 3:4" },
  { key: "collection_2", label: "Featured Collection — Card 2", width: 600, height: 800, note: "Portrait 3:4" },
  { key: "collection_3", label: "Featured Collection — Card 3", width: 600, height: 800, note: "Portrait 3:4" },
